<?php
	...
	*/
	function db_connection(){
		...
		$db	= mysql_connect($host,$user,$password) or die("数据库连接中......");//建立数据库链接
		$select_db	= mysql_select_db($database,$db) or die("数据库选择中......");//选择某个数据库
...
//die;
		...
		$rs_sql = $sql." limit $start,$page_size";
		//echo $rs_sql;
		//die;
