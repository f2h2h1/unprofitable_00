...
<body>
	...
	<!-- <nav class="navbar navbar-expand-sm navbar-dark"> -->
		<div class="container">
			...
			<a class="navbar-brand text-dark" href="index.php?r=Home/index"><?=$website['name']?></a>
			...
			<?php if (isset($userName)):?>
				<ul class="navbar-nav flex-grow-1">
					...
					<?php if ($userRole === 3):?>
						...
						<li class="nav-item">
							<a class="nav-link" href="index.php?r=Student/ExamList">考核</a>
						</li>
						<li class="nav-item">
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="index.php?r=Home/changePassword">修改密码</a>
							<a class="dropdown-item" href="index.php?r=Home/logout">退出</a>
						</div>
					</li>
				</ul>
			<?php endif;?>
