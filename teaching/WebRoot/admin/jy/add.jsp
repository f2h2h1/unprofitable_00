...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		if(method.equals("upjy")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from jy where id='"+id+"'",6);
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">课程讲义名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr>  
      
     <%if(method.equals("upjy")){ %>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">上传课程讲义：</td>
