...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		if(method.equals("uprw")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from rw where id='"+id+"'",4);
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">任务名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr>  
     <%if(method.equals("uprw")){ %>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">上传任务书：</td>
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">任务说明：</td>
