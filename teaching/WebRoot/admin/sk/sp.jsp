...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		String tg = cb.getString("select tg from sk where id='"+id+"'"); 
		String yj = cb.getString("select yj from sk where id='"+id+"'");
%>
<body>
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">审批计划：</td>
     <td><select name="tg">
