   ...
   <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="rtable">
	  <tbody>
         ...
         <tr class="tr1">
            ...
            <INPUT type="radio" name="sf" value="学生" checked="checked"> 学生 
            <input type="radio" name="sf" value="教师" > 教师 
            <input type="radio" name="sf" value="教研室管理员" > 教研室管理员  
            <input type="radio" name="sf" value="系统管理员" > 系统管理员</td> 
         </tr> 
         <tr class="tr1">
            <td class="rldatee daslist"></td>
