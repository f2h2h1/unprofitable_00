...
<FORM name="form1" method="post" action="<%=basePath%>MemberServlet?method=mreg"> 
   <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="rtable">
	  <tbody>
	     ...
	     <tr class="tr1">
			<td class="rldatee daslist">学生学号：</td>
         ...
         <tr class="tr1">
			<td class="rldatee daslist">班级：</td>
            <td class="rltitle dotlist"><input type="text" size="30" name="age" required /></td> 
         </tr>
         <tr class="tr1">
			<td class="rldatee daslist">联系电话：</td>
            <td class="rltitle dotlist"><input type="text" size="30" name="address" pattern="[0-9]{11}" title="11位手机号码" required /></td> 
         </tr>
         <tr class="tr1">
