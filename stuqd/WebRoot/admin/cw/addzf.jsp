...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">商品编号:</td>
     <td>
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">商品名称：</td>
     <td><input type="text" name="name" class="span4" value="<%=name%>" required/></td> 
     </tr> 
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">商品分类：</td>
     <td><input type="text" name="gclass" class="span2" value="<%=gclass%>" required/></td> 
     </tr> 

     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">库存：</td>
