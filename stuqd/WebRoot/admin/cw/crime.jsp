...
<div class="title_right"><strong>商店管理</strong></div>  
...
%>
<label>商店编号：<input type="text" name="shop_id" value="<%=shop_id%>"></label>
<label>商店名称：<input type="text" name="shop_name" value="<%=shop_name%>"></label>
<label>联系电话：<input type="text" name="shop_phone" value="<%=shop_phone%>"></label>
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>商店编号</strong></td>   
         <td nowrap="nowrap"><strong>商店名称</strong></td>
...
String sql1;
	String sql2;
	String tableName = "tb_shop";
	Queue<String> queue = new LinkedList<String>();
	int count = 0;
	if(!shop_id.equals("")){
		count++;
		queue.offer(" id = " + shop_id + " ");
	}
	if(!shop_name.equals("")){
		count++;
		queue.offer(" shop_name like '%" + shop_name + "%' ");
	}
	if(!shop_phone.equals("")){
		count++;
		queue.offer(" phone like '%" + shop_phone + "%' ");
	}
	String where = "";
	if (count > 0) {
		where = " where ";
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap">
         <a href="<%=basePath%>admin/cw/addzx.jsp?method=upzx&id=<%=pagelist2.get(0).toString()%>">修改</a> 
         <a href="<%=basePath%>ComServlet?method=delzx&id=<%=pagelist2.get(0).toString()%>">删除</a>
         </td>
       </tr>
<% }} %>
       <tr align="center">
